                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Rekening Bank</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="sparkline13-list shadow-reset">
                                ...
                                <div class="sparkline13-graph">
                                    <div class="datatable-dashv1-list custom-datatable-overright">
                                        ...
                                        <div align="left">
                                            <a href="index2.php?part=Tambah Rekening Bank"><button type="button" class="btn btn-success">
                                        ...
                                        <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="false" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th data-field="tanggal_artikel" data-editable="true">No. Rekening</th>
                                                    <th data-field="judul_artikel" data-editable="true">Nama Bank</th>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><a href="index2.php?part=Edit Rekening Bank&id=<?php echo $dt['id'];?>" class="btn btn-primary" value="edit" style='width: 70px'>Edit</a> <br> <a href="modul/rekening/aksi.php?part=hapus&id=<?php echo $dt['id'];?>" class="btn btn-danger btn-small" value="hapus" onClick="return confirm('Apakah Anda Yakin Hapus Data?')"  style='width: 70px'>Hapus</a></td>
                                                </tr>
                                                <?php } ?>
                                            </tbody>
                                        </table>
